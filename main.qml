...
ApplicationWindow {
    ...
    Drawer {
        ...
        ListView {
            ...
            model: ListModel {
                ListElement { title: "Dashboard"; source: "Dashboard-page.qml" }
                ListElement { title: "File Scanner"; source: "FileScan-page.qml" }
                ListElement { title: "Security Check"; source: "" }
                ListElement { title: "Firewall Config"; source: "" }
                ListElement { title: "Net Analysis"; source: "" }
            }
